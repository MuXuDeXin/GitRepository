 ...
 * 光伏运行汇总日报excel实体
 */
public class GfRunSumDailyExcel {
    // 公司
    @ExcelField(title = "公司", order = 1)
    private String company;

    // -光伏站
    @ExcelField(title = "光伏站", order = 2)
    private String station;

    // -逆变器型号
    @ExcelField(title = "逆变器型号", order = 3)
    ...
    // -逆变器运行台数
    @ExcelField(title = "逆变器运行台数", order = 6)
    ...
    // -月平均辐照度
    @ExcelField(title = "月平均辐照度\n" + "(kWh/m2)", order = 27)
    private String value2;

    // -年平均辐照度
    @ExcelField(title = "年平均辐照度\n" + "(kWh/m2)", order = 28)
