 ...
 * 水电运行汇总日报excel实体
 */
public class SdRunSumDailyExcel {
    // 公司
    @ExcelField(title = "公司", order = 1)
    private String company;

    // -风电场
    @ExcelField(title = "水电站", order = 2)
    private String station;

    // -风机型号
    @ExcelField(title = "机组型号", order = 3)
    ...
    // -机组运行台数
    @ExcelField(title = "机组运行台数", order = 6)
    ...
    // -月平均入库流量
    @ExcelField(title = "月平均入库流量\n" + "(m3/s)", order = 27)
    private String value2;

    // -年平均入库流量
    @ExcelField(title = "年平均入库流量\n" + "(m3/s)", order = 28)
